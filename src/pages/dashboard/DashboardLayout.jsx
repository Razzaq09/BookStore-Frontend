...
const DashboardLayout = () => {
  ...
  return (
    ...
    <aside className="hidden sm:flex sm:flex-col">
      ...
      <div className="flex-grow flex flex-col justify-between text-black bg-gray-800">
        <nav className="flex flex-col mx-4 my-6 space-y-4">
          <a href="#" className="inline-flex items-center justify-center py-3 hover:bg-gray-700 focus:bg-gray-700 rounded-lg">
    ...
    <div className="flex-grow text-black">
      <header className="flex items-center h-20 px-6 sm:px-10 bg-white">
        <button className="block sm:hidden relative flex-shrink-0 p-2 mr-2 text-black hover:bg-gray-100 focus:bg-gray-100 rounded-full">
        ...
        <div className="relative w-full max-w-md sm:-ml-2">
          ...
          <input type="text" role="search" placeholder="Search..." className="py-2 pl-10 pr-4 w-full border-4 border-transparent placeholder-black focus:bg-gray-50 rounded-lg" />
        </div>
        <div className="flex flex-shrink-0 items-center ml-auto">
          <div className="border-l pl-3 ml-3 space-x-1">
            <button className="relative p-2 text-black hover:bg-gray-100 focus:bg-gray-100 rounded-full">
            ...
            className="relative p-2 text-black hover:bg-gray-100 focus:bg-gray-100 rounded-full">
      ...
      <main className="p-6 sm:p-10 space-y-6 ">
        <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
          <div className="mr-6">
            ...
            <h2 className="text-black ml-0.5">Book Store Inventory</h2>
          </div>
